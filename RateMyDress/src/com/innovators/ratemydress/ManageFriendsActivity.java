...
public class ManageFriendsActivity extends ListActivity {
	...
	public static final String TAG = ManageFriendsActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Check and un check the selection
		...
		query.findInBackground(new FindCallback<ParseUser>() {
			public void done(List<ParseUser> users, ParseException e) {
				...
				if(e == null){
					...
					ArrayAdapter<String> adapter = new ArrayAdapter<String>(ManageFriendsActivity.this, 
