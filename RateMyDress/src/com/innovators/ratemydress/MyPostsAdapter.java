...
public class MyPostsAdapter extends ArrayAdapter<ParseObject>{

	protected Context mContext;
	protected List<ParseObject> mNotifications;
	
	public MyPostsAdapter(Context context, List<ParseObject> myPosts) {
		super(context, R.layout.notification_item, myPosts);
		mContext = context;
		mNotifications = myPosts;
	}
